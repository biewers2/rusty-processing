...
use rusty_processing::processing::{processor, ProcessOutputData, ProcessType};
...
fn test_mbox_file() -> anyhow::Result<()> {
    ...
    //         dedupe_id: "4d338bc9f95d450a9372caa2fe0dfc97".into(),
    //     },
    //     ProcessOutputData {
    //         output_type: ProcessOutputForm::Embedded,
    //         path: "5e574a8f0d36b8805722b4e5ef3b7fd9/original.eml".into(),
    //         mimetype: "message/rfc822".into(),
    //         dedupe_id: "5e574a8f0d36b8805722b4e5ef3b7fd9".into(),
    //     },
    // ]);
    //
